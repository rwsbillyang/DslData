 ...
 * Accessing this variable in a destroyed fragment will throw NPE.
 */
class AutoClearedValue2<T : Any>(activity: AppCompatActivity) : ReadWriteProperty<AppCompatActivity, T> {
    private var _value: T? = null
...
fun <T : Any> AppCompatActivity.autoCleared() =
    AutoClearedValue2<T>(this)